...
public class CustomerController {
	...
	public ResponseEntity<RestAPIResponse> saveCustomerData(@RequestBody Customer customer) {
		...
		try {
			return new ResponseEntity<>(new RestAPIResponse("success", "Registered Successfully",
					customerServiceImpl.createCustomer(customer)), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<RestAPIResponse> allCustomers() {
		try {
			return new ResponseEntity<>(
					new RestAPIResponse("success", "User Data getting Successfully", customerServiceImpl.getAll()),
					HttpStatus.OK);
		} catch (Exception e) {
